            ...
            <li className="relative" key={route.name}>
              {route?.outside ? (
                <a
                  ...
                  target="_blank"
                  className="px-6 py-4 inline-flex items-center cursor-pointer w-full text-sm font-semibold transition-colors duration-150 hover:text-pink-700 dark:hover:text-gray-200"
                  rel="noreferrer"
                >
                ...
                <NavLink
                  ...
                  activeClassName="text-pink-500 dark:text-gray-100"
                >
                  <Route path={route.path} exact={route.exact}>
                    <span
                      className="absolute inset-y-0 left-0 w-1 bg-pink-500 rounded-tr-lg rounded-br-lg"
                      aria-hidden="true"
                    ></span>
                  </Route>
                  <route.icon className="w-5 h-5" aria-hidden="true" />
